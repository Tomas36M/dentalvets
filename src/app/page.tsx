            ...
            >
              ...
              <div className="flex items-center space-x-6 text-sm hero-features">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white force-white-text" style={{ color: '#ffffff' }}>Sin anestesia</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="text-green-500" size={20} />
            ...
            {[
              {
                ...
                specialty: 'Medicina veterinaria especialista en odontología veterinaria',
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-900 font-medium mb-2">{member.specialty}</p>
